...
""));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the MusCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        ...
        labelAnonymized->setText(QApplication::translate("OverviewPage", "0 MusCoin", 0));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", 0));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 MusCoin / 0 Rounds", 0));
        label_9->setText(QApplication::translate("OverviewPage", "Submitted Denom:", 0));
#ifndef QT_NO_STATUSTIP
        labelSubmittedDenom->setStatusTip(QApplication::translate("OverviewPage", "The denominations you submitted to the Adrenaline Node. To mix, other users must submit the exact same denominations.", 0));
        ...
        toggleDarksend->setText(QApplication::translate("OverviewPage", "Start/Stop", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the MusCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
