...
public:
    ...
    void setupUi(QWidget *MasternodeManager)
    {
        ...
        sizePolicy.setHeightForWidth(countLabel->sizePolicy().hasHeightForWidth());
        countLabel->setSizePolicy(sizePolicy);

        horizontalLayout_3->addWidget(countLabel);


        gridLayout2->addLayout(horizontalLayout_3, 0, 0, 1, 1);
        ...
        horizontalLayout_41->setContentsMargins(-1, -1, -1, 0);
        startButton = new QPushButton(tab_2);
        startButton->setObjectName(QStringLiteral("startButton"));

        horizontalLayout_41->addWidget(startButton);

        stopButton = new QPushButton(tab_2);
        stopButton->setObjectName(QStringLiteral("stopButton"));

        horizontalLayout_41->addWidget(stopButton);
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "MusCoin Nodes Count:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        filterLabel->setText(QApplication::translate("MasternodeManager", "Filter:", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Mus Nodes Network", 0));
        ...
        ___qtablewidgetitem8->setText(QApplication::translate("MasternodeManager", "Status", 0));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget_2->horizontalHeaderItem(3);
        ___qtablewidgetitem9->setText(QApplication::translate("MasternodeManager", "Collateral Address", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MasternodeManager", "My Mus Nodes", 0));
    } // retranslateUi
